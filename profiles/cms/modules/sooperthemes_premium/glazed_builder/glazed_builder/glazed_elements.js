(function($) {
  ...
  function getButtonsStyle() {
    ...
    for (var name in drupalSettings.glazedBuilder.buttonStyles) {
      value.push(p + name);
      keys.push(drupalSettings.glazedBuilder.buttonStyles[p + name]);
    }
    ...
    },
  {
    ...
    render: function($) {
      this.dom_element = $('<div class="az-element az-alert alert ' + this.attrs['type'] + ' ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this.attrs['style'] + '">' + this.attrs['message'] + '</div>');
...

  {
    ...
    render: function($) {
      ...
      if (reverse != '')
        reverse = p + reverse;
      this.dom_element = $('<blockquote class="az-element az-blockquote ' + this.get_el_classes() + ' ' + this.get_content_classes() + ' ' +
        reverse + '" style="' + this.attrs['style'] + '">' + content + '</blockquote>');
    ...
    render: function($) {
      if (this.attrs['link'] == '') {
        this.dom_element = $('<div class="az-element az-button ' + this.get_el_classes() +
          '"><button type="button" class="btn ' + this.attrs['type'] + ' ' + this.attrs['size'] + ' ' + this.attrs['block'] + this.get_content_classes() +
        ...
        this.dom_element = $('<div class="az-element az-button ' + this.get_el_classes() + '"><a href="' +
          this.attrs['link'] + '" type="button" class="btn ' + this.attrs['type'] + ' ' + this.attrs['size'] + ' ' + this.attrs['block'] + this.get_content_classes() +
...

  {
    ...
    render: function($) {
      ...
      this.dom_element = $('<div class="az-element az-circle-counter ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' +
      ...
      var libraries = 'circliful waypoints';
      var icon_set = this.attrs['icon'].charAt(0);
      switch (icon_set) {
        case 'e':
        libraries = libraries + ' et_line_font';
          break;
        case 'f':
        libraries = libraries + ' font_awesome';
          break;
        case 'p':
        libraries = libraries + ' pe_icon_7_stroke';
          break;
        default:
          break;
      }
      $(this.dom_element).attr('data-glazed-builder-libraries', libraries);
      this.baseclass.prototype.render.apply(this, arguments);
    },
  },

  {
    ...
    render: function($) {
      this.dom_element = $('<div class="az-element az-countdown ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this
          .attrs['style'] + '" data-glazed-builder-libraries="counteverest"></div>');
...

  {
    ...
    render: function($) {
      this.dom_element = $('<div class="az-element az-counter"><div id="' + this.id + '" class="'
        + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this.attrs['style']
        + '" data-glazed-builder-libraries="countto waypoints">'
        + this.attrs['start'] + '</div></div>');
...

  {
    ...
    has_content: true,
    render: function($) {
      this.dom_element = $('<div class="az-element az-html ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this.attrs[
    ...
    render: function($) {
      ...
      switch (icon_set) {
        ...
        case 'mat':
          ...
          this.add_css('vendor/material-icons/material-icons.css', 'fontAwesome' in $.fn, function() {});
          this.add_css('css/icon-helpers.css', 'IconHelpers' in $.fn, function() {});
          libraries = libraries + ' material_icons';
        ...
        case 'fab':
          ...
          this.add_css('vendor/font-awesome-5-pro/css/fontawesome-all.min.css', 'fontAwesome' in $.fn, function() {});
          libraries = libraries + ' font_awesome_5_pro';
          break;
        case 'gly':
          // Glyphicons
          this.add_css('css/icon-helpers.css', 'IconHelpers' in $.fn, function() {});
      ...
      if (this.attrs['st_theme_color'] == '') {
        ...
        if ('palette' in drupalSettings.glazedBuilder && drupalSettings.glazedBuilder.palette != null && this.attrs[
            'st_theme_color'] in drupalSettings.glazedBuilder.palette)
          icon_style = icon_style + 'color: ' + drupalSettings.glazedBuilder.palette[this.attrs['st_theme_color']] +
            ';';
        else
      ...
      if (this.attrs['st_theme_bgcolor'] == '') {
        ...
        if ('palette' in drupalSettings.glazedBuilder && drupalSettings.glazedBuilder.palette != null && this.attrs[
            'st_theme_bgcolor'] in drupalSettings.glazedBuilder.palette)
          icon_style = icon_style + 'background-color: ' + drupalSettings.glazedBuilder.palette[this.attrs[
              'st_theme_bgcolor']] + ';';
        else
      ...
      var icon_html = '<div class="az-element az-icon ' + this.get_el_classes() + '"><i class="' + this.attrs[
        ...
        this.attrs['pull'] + ' ' + this.attrs['animation'] + ' ' + this.attrs['orientation'] + ' ' + this.get_content_classes() + '" style="' +
        this.attrs['style'] + icon_style + '">' + ligature + '</i></div>';
      if (this.attrs['link'] == '') {
        this.dom_element = $(icon_html);
      }
      else {
        this.dom_element = $('<a href="' + this.attrs['link'] + '" class="az-element az-icon' +
...

  {
    ...
    render: function($) {
      ...
      var content_classes = this.get_content_classes();
      function render_image(value, style, width, height, alt, title) {
        if ($.isNumeric(width))
          width = width + 'px';
        if ($.isNumeric(height))
          height = height + 'px';
        var img = $('<img class="' + content_classes + '" src="' + value + '" alt="' + alt + '" title="' + title + '">');
...

  {
    ...
    render: function($) {
      ...
      this.dom_element = $('<div id="' + this.id + '" class="az-element az-images-carousel carousel ' +
        'slide ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" data-ride="carousel" style="' + this.attrs['style'] +
        '"></div>');
...

  {
    ...
    controls_base_position: 'top-left',
    render: function($) {
      this.dom_element = $('<div class="az-element az-ctnr az-jumbotron jumbotron ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this.attrs['style'] + '"></div>');
      this.dom_content_element = this.dom_element;
      this.baseclass.prototype.render.apply(this, arguments);
    },
  },

  {
    ...
    render: function($) {
      this.dom_element = $('<div class="az-element az-link ' + this.get_el_classes() + ' ' + this.get_content_classes() + '"></div>');
...

  {
    ...
    has_content: true,
    render: function($) {
      this.dom_element = $('<div style="line-height: 0;" class="az-element az-map ' + this.get_el_classes() + ' ' + this.get_content_classes() + '"></div>');
...

  {
    ...
    controls_base_position: 'top-left',
    render: function($) {
      this.dom_element = $('<div class="az-element az-panel panel ' + this.get_el_classes() + ' ' + this.get_content_classes() + ' ' +
...

  {
    ...
    render: function($) {
      ...
      this.dom_element = $('<div class="az-element az-progress-bar progress ' + this.get_el_classes() + ' ' + this.get_content_classes() +
...

  {
    ...
    render: function($) {
      ...
      if ((this.attrs['width'] == 'custom')) {
       ...
       this.dom_element = $('<hr class="az-element az-separator ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this.attrs[
...

  {
    ...
    has_content: true,
    render: function($) {
      this.dom_element = $('<div class="az-element az-text ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this.attrs[
          'style'] + '">' + this.attrs['content'] + '</div>');
      this.dom_content_element = this.dom_element;
      this.baseclass.prototype.render.apply(this, arguments);
    },
...

  {
    ...
    render: function($) {
      ...
      this.dom_element = $('<div class="az-element az-video embed-responsive embed-responsive-16by9 ' + this.get_el_classes() + ' ' + this.get_content_classes() + '" style="' + this.attrs['style'] + '"></div>');
...

  {
    ...
    controls_base_position: 'top-left',
    render: function($) {
      this.dom_element = $('<div class="az-element az-well well ' + this.get_el_classes() + ' ' + this.get_content_classes() + ' ' +
        this.attrs['type'] + '" style="' + this.attrs['style'] + '"></div>');
...

  {
    ...
    render: function($) {
      ...
      this.add_css('css/icon-helpers.css', 'IconHelpers' in $.fn, function() {});
      this.add_css('vendor/font-awesome/css/font-awesome.min.css', 'fontAwesome' in $.fn, function() {});
      this.dom_element = $('<ul class="az-element st-social stbe-social-links ' + this.get_el_classes() + ' ' + this.get_content_classes() +
        '" style="' + this.attrs['style'] + '" data-glazed-builder-libraries="social_icons font_awesome icon_helpers"></ul>');
